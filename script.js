...
const translations = {
    de: {
        ...
        services: {
            ...
            pageDescription: 'Feste Preise für Websites kleiner Betriebe in Leverkusen, Köln und ganz NRW: Landingpage ab 600 €, Basis-Website ab 900 €, Wartung ab 60 € im Monat.',
            ...
            p4: {
                name: 'Wartung',
                price: '60–150 € im Monat',
                time: 'Monatlich kündbar',
                for: 'Damit die Website sicher und aktuell bleibt.',
                f1: 'Regelmäßige Updates',
                f2: 'Sicherungskopien Ihrer Website',
                f3: 'Überwachung der Erreichbarkeit',
                f4: 'Kleine Textänderungen',
                f5: 'Fester Ansprechpartner bei technischen Fragen',
    ...
    en: {
        ...
        services: {
            ...
            pageDescription: 'Fixed prices for small business websites in Leverkusen, Cologne and across North Rhine-Westphalia (NRW): landing page from €600, basic website from €900, maintenance from €60 per month.',
            ...
            p4: {
                ...
                time: 'Cancellable monthly',
                for: 'So the website stays secure and up to date.',
                f1: 'Regular updates',
                f2: 'Backups of your website',
                f3: 'Uptime monitoring',
                f4: 'Small text changes',
                f5: 'A fixed contact for technical questions',
                f6: 'Domain and hosting included — no further running costs'
            },
        ...
        contact: {
            ...
            form: {
                ...
                type4: 'Maintenance (€60–150 per month)',
    ...
    ru: {
        ...
        services: {
            ...
            pageDescription: 'Фиксированные цены на сайты для малого бизнеса в Леверкузене, Кёльне и по всей NRW: лендинг от 600 €, базовый сайт от 900 €, обслуживание от 60 € в месяц.',
            title: 'Услуги и цены',
            ...
            p4: {
                name: 'Обслуживание',
                price: '60–150 € в месяц',
                time: 'Отказаться можно в любой месяц',
                for: 'Чтобы сайт оставался безопасным и актуальным.',
                f1: 'Регулярные обновления',
                f2: 'Резервные копии сайта',
                f3: 'Контроль доступности сайта',
                f4: 'Мелкие правки текста',
                f5: 'Постоянный контакт по техническим вопросам',
        ...
        contact: {
            ...
            form: {
                ...
                type4: 'Обслуживание (60–150 € в месяц)',
